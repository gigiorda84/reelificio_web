      ...
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-md font-sans text-base text-ink/70">
              {t('tagline')}
            </p>
          </div>

          <div>
            <p className="font-mono text-xs uppercase text-lime/70">Sito</p>
          ...
          <div>
            <p className="font-mono text-xs uppercase text-lime/70">Legal</p>
            <ul className="mt-3 space-y-2 font-sans text-sm">
              <li>
        ...
        <div className="mt-12 border-t border-white/10 pt-6">
          <div className="flex flex-col gap-2 font-mono text-xs uppercase text-ink/40 md:flex-row md:items-center md:justify-between">
            <p>
